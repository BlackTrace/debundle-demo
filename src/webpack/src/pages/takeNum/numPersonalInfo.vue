...
this.$axios.get(this.$aipConfig.takeNumberByLinkman, {params:{linkmanId:res.data.data , depaCode: _this.$route.query.depaCode}}).then((r) => {
setTimeout(function(){
...
// WEBPACK FOOTER //
// ./src/pages/takeNum/numPersonalInfo.vue